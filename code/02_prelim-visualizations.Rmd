...
t.test(mean ~ lifestage, data = test %>% filter(site == "Arroyo Quemado"))
t.test(mean ~ lifestage, data = test %>% filter(site == "Mohawk"))

var.test(mean ~ site, data = test %>% filter(lifestage == "adult"))
var.test(mean ~ site, data = test %>% filter(lifestage == "new_recruit"))
# homogeneous variance
t.test(mean ~ site, data = test %>% filter(lifestage == "adult"))
t.test(mean ~ site, data = test %>% filter(lifestage == "new_recruit"))
...
test_plot <- fvfm_raw %>% 
  ...
  labs(title = "PTCA Fv/Fm",
       caption = "t-test: Arroyo Quemado: t(3.67) = 7.05, p = 0.003, Mohawk: t(2.4) = 6.7, p = 0.01") 

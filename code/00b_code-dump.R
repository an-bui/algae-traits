...
# irr_test <- read_csv(here::here("data/SBC-LTER-benthics", "Hourly_Irrandiance_All_Year_20220131.csv")) %>%
#   clean_names() %>% 
#   # split up dates into year, month, and day
#   separate(date_local, into = c("year", "month", "day"), sep = "-", remove = FALSE) %>% 
#   unite("transect_ID", site, transect, sep = "_", remove = FALSE)


###### OLD CLEANING AND SUMMARIZING SCRIPT ######

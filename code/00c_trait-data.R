...
weight <- read_csv(here::here("data", "google-sheet-traits", "weight_sheet_2024-01-15.csv"))

# ⊣ g. surface area and perimeter ---------------------------

sa_peri <- read_csv(here::here("data", "google-sheet-traits", "sa_peri_sheet_2024-01-15.csv"))

...
=======
             size = 3,
>>>>>>> c0e0ed2af309f6fbabbc01f00c3261d58aa02db9
             alpha = 0.9) +
...
=======
  annotate(geom = "text", x = -0.2, y = 0.15, label = "1", color = cluster1, size = 8) +
  annotate(geom = "text", x = -0.1, y = -0.1, label = "2", color = cluster2, size = 8) +
  annotate(geom = "text", x = 0.2, y = -0.2, label = "3", color = cluster3, size = 8) +
  annotate(geom = "text", x = 0.2, y = 0.1, label = "4", color = cluster4, size = 8) +
  labs(title = "PAM clusters with continuous traits") +
  theme_bw() +
  theme(legend.position = "none",
        panel.grid = element_blank())
...
=======
  annotate(geom = "text", x = 0.2, y = -0.2, label = "1", color = cat_cluster1, size = 8) +
  annotate(geom = "text", x = -0.2, y = 0, label = "2", color = cat_cluster2, size = 8) +
  labs(title = "PAM clusters with categorical traits") +
  theme_bw() +
  theme(legend.position = "none",
        panel.grid = element_blank())

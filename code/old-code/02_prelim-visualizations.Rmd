...
# ggsave(here::here("figures/basic-visualizations",
...
ggsave(here::here("figures", "basic-visualizations", paste("fvfm-boxplot-01_BB_", today(), ".jpg", sep = "")))
...
adult_plot
ggsave(here::here("figures", "basic-visualizations", paste("fvfm-boxplot-02_BB_", today(), ".jpg", sep = "")))
```
...
```{r include = FALSE}
# Use `rmarkdown::render(here::here("code", "02_basic-visualizations.Rmd"))` to knit the document.
```
